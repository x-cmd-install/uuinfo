...
[![x-cmd/install — uuinfo Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/uuinfo.svg?lang=zh)](https://x-cmd.com/install/uuinfo)
...
合计: **5,617** 行代码（覆盖前 5 种语言、共 **63** 个文件）。
...
- **上游仓库**: <https://github.com/Racum/uuinfo>
- **许可证**: NOASSERTION

## 发布

- **最新版本**: `v0.7.5` (2026-05-31)
- **最近提交**: 2026-05-31
- **Release 含资产**: 7 个

## 流行度

- **Star**: 65 · **Fork**: 5 · **开放 issue**: 0 · **贡献者**: 2

## 累计统计

- **发布数**: 4 · **已合并 PR**: 1 · **开放 PR**: 0 · **已关闭 issue**: 0 · **开放 issue**: 0 · **提交数**: 116
...
| last180d | 2026-03-30 | 4 | 0 | 0 | 0 | 0 | 23 |
| 360d | 2025-10-01 | 4 | 0 | 0 | 0 | 0 | 35 |
| last720d | 2024-10-06 | 4 | 1 | 0 | 0 | 0 | 116 |
...
uuinfo 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `uuinfo` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/uuinfo.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T05:28:11Z._
